Feature: Insurances_smoke
  ...
  @smoke
  Scenario: user validates Travel insurance destination page in policy bazaar
  ...
  @smoke
  Scenario: user validates Travel insurance trip date page in policy bazaar
  ...
  @smoke
  Scenario: user validates Travel insurance traveller page in policy bazaar
  ...
  @smoke
  Scenario: user validates Travel insurance medical history page in policy bazaar
    Given user navigated to medical history page
    When user selects either of value i.e yes/no
    Then clicks on next button4
  
  @smoke
  Scenario: user validates Travel insurance results page in policy bazaar
  ...
  @smoke
  Scenario: user validates car insurance home page in policy bazaar
  ...
  @smoke
  Scenario: user validates car insurance RTO page in policy bazaar
  ...
  @smoke
  Scenario: user validates car insurance brand name page in policy bazaar
  	Given user navigated to car insurance page
  	When user verifies the brand name page
  	Then user selects a brand 
  @smoke
  Scenario: user validates car insurance model name page in policy bazaar
  	Given user navigated to car insurance page
  	When user verfies model name page
  	Then user selects the model name
  @smoke
  Scenario: user validates car insurance model fueltype page in policy bazaar
  	Given user navigated to car insurance page
  	When user verifies fueltype name page
  	Then user selects fueltype name
  @smoke
  Scenario: user validates car insurance variant name page in policy bazaar
  	Given user navigated to car insurance page
  	When user verifies variant name page
  	Then user selects a variant name
  @smoke
  Scenario: user validates car insurance contact  page without details in policy bazaar
  	Given user navigated to car insurance page
    When user clicks on final view prices button
    Then capture error messages
 
  @smoke
  Scenario: user validates car insurance contact page with invalid phone number in policy bazaar
  	Given user navigated to car insurance page
    When user entered valid fullname, email and invalid phone
    Then capture error message invalid phone
  @smoke
  Scenario: user validates car insurance contact page with invalid email in policy bazaar
  	Given user navigated to car insurance page
	...
	@smoke
  Scenario: user validates Health insurance menu in policy bazaar
  ...
  @smoke
  Scenario: user validates Health insurance link in policy bazaar
  ...
  @smoke
  Scenario: user validates Health insurance age page in policy bazaar
  	Given user navigated to age page
  	Then user selects age from drop down
  	Then user clicks on continue2 button
  
	@smoke
	Scenario: user validates Health insurance city page in policy bazaar
  	Given user navigated to city page
  	Then user selects city from drop down and clicks on continue3 button
  		  	
  @smoke 
  Scenario: user validates Health insurance contact page with positive details in policy bazaar
